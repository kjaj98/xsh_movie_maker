...
- A sample movie generated from the included data is at `xsh_density_movie_480p.mp4` (embedded below and also downloadable). The full-resolution file `xsh_density_movie.mp4` stays in the repo if you want it.
...
<p align="center">
  <video controls width="720">
    <source src="xsh_density_movie_480p.mp4" type="video/mp4">
    <!-- GitHub sometimes needs a fully-qualified raw URL for inline playback -->
    <source src="https://raw.githubusercontent.com/kitjoll/xsh_movie_maker/main/xsh_density_movie_480p.mp4" type="video/mp4">
    Your viewer may block inline video; use the download link below.
  </video>
</p>

<p align="center">
  <a href="xsh_density_movie_480p.mp4">Download the small MP4</a><br/>
  <a href="xsh_density_movie.mp4">Download the full-resolution MP4</a>
</p>
